...
class IndexController extends Controller
{
    ...
    function _empty()
    {
        // $url='http://whois.pconline.com.cn/ipJson.jsp?callback=testJson&ip='.get_user_ip();
        // $data = file_get_contents($url);
        /// $format=var_dump(json_decode($data));
        // mb_convert_encoding( $data, 'UTF-8', 'UTF-8,GBK,GB2312,BIG5' );
        // $format = json_encode($data, true);
        $this->_ipname();
        ///
        // 地址类型
     ...
     * */
    private
    function urlJump($type, $isSecSiteDir)
    {
